...
4. Import public deck JSON from Moxfield and Archidekt URLs
...
## Features
* **Moxfield and Archidekt Integration**: Import public decklists from either site. Moxfield imports use Decklist.gg first, with direct Moxfield retrieval as a recovery path.
